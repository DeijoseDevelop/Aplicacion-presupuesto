...
const eliminarIngreso = (id)=>{
    let indiceEliminar = ingresos.findIndex(ingreso => ingreso.id === id);//! for(let ingreso of ingresos){}
...
const agregarDato = ()=>{
    ...
    if(descripcion.value !== '' && valor.value !== ''){
        if(tipo.value === 'ingreso'){
            ingresos.push(new Ingreso(descripcion.value, Number(valor.value))); //?+valor.value(convierte a valor numerico)
            cargarCabecero();
            cargarIngresos();
